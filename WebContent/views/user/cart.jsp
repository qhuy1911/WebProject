...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="HomeServlet">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Cart</strong></div>
        </div>
      </div>
    </div>
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="product-thumbnail">
                      <img src="${pageContext.request.contextPath}/views/user/images/${cartItem.product.image }" alt="Image" class="img-fluid">
                    </td>
              ...
              <div class="col-md-7">
                ...
                <div class="row mb-5">
                  ...
                  <div class="col-md-6 text-right">
                    <strong class="text-black">$ ${cart.sumPrice }</strong>
                  </div>
                </div>
