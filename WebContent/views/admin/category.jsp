                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                      	<c:forEach var="item" items="${listC}">
                        	<tr >
                         		...
                         		<td> ${item.name } </td>
                          		<td>  
                            		<a href="EditCategory?cid=${item.id }" > <i class="icon-table icon-edit mdi mdi-grease-pencil "></i></a> 
                            		<a href="DeleteCategory?cid=${item.id }"><i class="icon-table icon-delete mdi mdi-delete "  style="color: crimson;"></i></a>
                          		</td>
                        	</tr>
                      ...
                      <div style="margin-top: 20px;"><button type="button" class="btn btn-gradient-success btn-fw">
                        <a href="AddCategory" style="color: white; text-decoration: none">Add new</a>
                      </button>
                    </div>
                  </div> 
                </div>
